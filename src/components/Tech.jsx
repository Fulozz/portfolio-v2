...
export default function Tech() {
  ...
  return (
    <div className="sm:mx-[40px] md:mx-[200px] pt-40 my-[50px]">
      ...
      <h4 className='mx-3 text-[1rem]'>Trabalho a 1 ano e meio como desenvolvedor Full-Stack em projetos freelances desenvolvendo SASS, APIs internas, e Web-Softwares e landing pages.</h4>
    </div>
  )
}
